...
```{r}
teams <- read_csv("~/march-madness-predictor/data/Team Names.csv")
```
...
```{r}
total_team_distance_traveled <- merge <- full_join(favorite_data_table, underdog_data_table, by = c("Year" = "Year", "team_name" = "team_name"))
```



```{r}
total_team_distance_traveled <- left_join(favorite_data_table, underdog_data_table, by = c("Year" = "Year", "team_name" = "team_name"))
```
